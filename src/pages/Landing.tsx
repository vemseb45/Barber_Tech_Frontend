    ...
    <div className="relative min-h-screen bg-slate-50 dark:bg-[#0a0a0f] text-slate-900 dark:text-slate-100 font-sans antialiased overflow-x-hidden transition-colors duration-500 flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="bg-white dark:bg-black/20 px-6 py-20 lg:px-10 border-y border-slate-200 dark:border-white/5 transition-colors duration-300" id="servicios">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={staggerContainer} className="mx-auto max-w-7xl">
            <div className="mb-16 text-center">
              ...
              <motion.p variants={fadeUpVariant} className="mt-6 text-slate-600 dark:text-slate-400">Ofrecemos una gama completa de servicios de cuidado personal.</motion.p>
            </div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={staggerContainer} className="mx-auto max-w-7xl">
            <div className="mb-12 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
              <motion.div variants={fadeUpVariant}>
                <h2 className="text-3xl font-extrabold text-slate-900 dark:text-slate-100 md:text-4xl">Galería de Estilos</h2>
                <p className="mt-4 text-slate-600 dark:text-slate-400">Nuestro trabajo reciente.</p>
              </motion.div>
        ...
        <section className="bg-primary/5 px-6 py-20 lg:px-10" id="testimonios">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={staggerContainer} className="mx-auto max-w-7xl text-center">
            <motion.h2 variants={fadeUpVariant} className="text-3xl font-extrabold text-slate-900 dark:text-slate-100 md:text-4xl mb-16">
              ...
              {[
                ...
                <motion.div key={idx} variants={fadeUpVariant} whileHover={{ y: -5 }} className="rounded-3xl bg-white dark:bg-[#1a1a24] p-8 shadow-xl border border-black/5 dark:border-white/10 text-left">
                  ...
                  <div className="flex items-center gap-4 border-t border-black/5 dark:border-white/10 pt-4">
                    <div className="h-12 w-12 rounded-full bg-primary/20 flex items-center justify-center text-primary font-black">{t.init}</div>
                    <div>
        ...
        <section className="px-6 py-20 lg:px-10" id="contacto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={staggerContainer} className="mx-auto max-w-7xl">
            <div className="grid gap-12 lg:grid-cols-2">
              <motion.div variants={fadeUpVariant} className="flex flex-col gap-8">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <motion.div key={i} whileHover={{ x: 10 }} className="flex items-start gap-4 rounded-2xl p-4 bg-slate-50 dark:bg-white/5 border border-black/5 dark:border-white/10 transition-all">
              ...
              <motion.div variants={scaleUpVariant} className="h-[400px] overflow-hidden rounded-[32px] bg-slate-200 shadow-2xl border-4 border-white dark:border-white/10 relative group">
                <div className="absolute inset-0 grayscale opacity-40 group-hover:opacity-60 transition-opacity bg-cover bg-center" style={{ backgroundImage: "url('/Imagenes/fondobt.png')" }}></div>
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="p-6 bg-white dark:bg-[#1a1a24] rounded-2xl shadow-2xl text-center border border-black/5 dark:border-white/10">
      ...
      <footer className="border-t border-black/5 dark:border-white/5 bg-slate-100 px-6 py-12 dark:bg-[#0a0a0f] transition-colors mt-auto">
        <div className="mx-auto max-w-7xl grid gap-10 md:grid-cols-3">
          ...
          <div>
            <h4 className="mb-6 font-bold uppercase tracking-wider text-[10px] opacity-50">Legal</h4>
