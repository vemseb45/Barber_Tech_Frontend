        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <select 
              ...
              className="w-full p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all dark:text-white font-bold text-sm"
            >
          ...
          {/* MENSAJES DE ESTADO */}
          {mensaje && (
            <div className={`p-4 rounded-2xl flex items-center gap-3 text-sm font-bold animate-in zoom-in-95 ${
              mensaje.type === 'success' ? 'bg-green-100 text-green-700 dark:bg-green-900/30' : 'bg-red-100 text-red-700 dark:bg-red-900/30'
            }`}>
